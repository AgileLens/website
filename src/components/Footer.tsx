...
const socialLinks = [
  ...
  {
    href: 'https://www.facebook.com/agilelens/',
    label: 'Facebook',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    href: 'https://www.instagram.com/agilelens/',
    label: 'Instagram',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    href: 'https://www.linkedin.com/company/agilelens',
    label: 'LinkedIn',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-muted">
              <a href="https://www.fisherdachs.com" target="_blank" rel="noopener noreferrer" className="block hover:text-text transition-colors">
                Fisher Dachs Associates
              </a>
              <a href="https://www.fmsp.com" target="_blank" rel="noopener noreferrer" className="block hover:text-text transition-colors">
                Fisher Marantz Stone
              </a>
              <a href="https://www.alexcoulombepresents.com" target="_blank" rel="noopener noreferrer" className="block hover:text-text transition-colors">
